...
namespace Zambon.Core.Security.Identity
{
    public class CoreUserManager<TUser> : UserManager<TUser> where TUser : class, IUsers
    {
        ...
        private readonly IOptions<ApplicationConfigs> _options;
        ...
        public CoreUserManager(IOptions<ApplicationConfigs> options, IUserStore<TUser> store, IOptions<IdentityOptions> optionsAccessor, IPasswordHasher<TUser> passwordHasher, IEnumerable<IUserValidator<TUser>> userValidators, IEnumerable<IPasswordValidator<TUser>> passwordValidators, ILookupNormalizer keyNormalizer, IdentityErrorDescriber errors, IServiceProvider services, ILogger<UserManager<TUser>> logger)
